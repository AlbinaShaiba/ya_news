...
def test_anonymous_user_cant_create_comment(client, id_for_args_news, form_data):
...
def test_user_can_create_note(author_client, id_for_args_news, form_data, news, author):
    url = reverse('news:detail', args=id_for_args_news)
...
def test_author_can_delete_comment(author_client, id_for_args_comment, id_for_args_news):
...
def test_user_cant_delete_comment_of_another_user(not_author_client, id_for_args_comment):
    url = reverse('news:delete', args=id_for_args_comment)
